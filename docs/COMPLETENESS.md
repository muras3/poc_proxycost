...
| T10 | 「EMS 比較」の範囲を Verdict 直下に明示 | 1行「Compared using Japan Post EMS for every company. Each company also offers cheaper methods (small packet, surface, couriers) that we do not price.」が常時出る |
