...
| やらない | 理由 |
|---|---|
| **宅配便（FedEx / DHL / UPS / SF / ECMS）の料金を出す** | **3つが同時に立っているため。**①**料率が非公開**——各社が個別に交渉した率で、公表された料金表がそもそも無い（日本郵便の他方式と違う点はここ）。②**通関が別モデル**——郵便の通関手数料モデル（US $9.35 / GB £8 / DE €7.50 / CA C$9.95 / SG S$10.90）が使えず、自社が通関業者になる経路になる。この表の「米国 FedEx／DDP 経路の課税モデル」の行がこれ。③**容積重量の軸が要り、寸法が入力に無い**。この表の「容積重量」の行がこれ。**中途半端に送料だけ差し替えると、送料は下がり通関は上がるという向きが逆の2つの誤りが総額に同居し、EMS 一本より悪くなる。**（**日本郵便の他方式**＝小形包装物・国際小包の航空/船便は、2026-09-07 にこの表から外した。表の下を見ろ） |
...
|---|---|---|
| 料金 | **公開済み**（`post.japanpost.jp/send/oversea/charge/list-normal｜list-parcel/zone1〜5`） | **非公開**（各社が個別交渉した料率） |
...
| 容積重量 | **不要**（実重量課金） | **必要**（＝上の表の「容積重量」の行）。**寸法は入力に無い** |

→ **日本郵便の他方式は「やらない」から外し、実装に着手する。**
→ **宅配便は「やらない」に残す**（上の表の1行目。理由は「ログイン必須」ではなく、
料率の非公開・通関の別モデル・容積重量の3つが同時に立つこと）。
