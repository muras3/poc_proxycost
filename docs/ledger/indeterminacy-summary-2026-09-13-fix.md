# 断定不能（rankIndeterminate）台帳 — 要約 (2026-09-13-fix)
...
**rankIndeterminate: 51/343（14.9%）** ／ 断定できた: 292/343（85.1%）
...
|---|---|---|
| 1 | courier-clearance-fee | 51 → **0** |

## 3. 断定できている条件の偏り

断定できた 292 件の内訳:

国別: US=49, FR=49, AU=49, CA=49, SG=49, GB=27, DE=20

重量別: 200g=49, 500g=49, 1000g=47, 2000g=39, 3000g=38, 5000g=35, 8000g=35

価格別: ¥3000=43, ¥10000=43, ¥30000=43, ¥60000=42, ¥100000=41, ¥150000=41, ¥250000=39
...
**「調べれば分かる」側が優勢、または拮抗。** 上位の findable 費目から潰していけば断定不能の削減が見込める。
