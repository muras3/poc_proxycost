# 断定不能（rankIndeterminate）台帳 — 要約 (2026-09-13b)
...
**rankIndeterminate: 82/343（23.9%）** ／ 断定できた: 261/343（76.1%）
...
|---|---|---|---|---|---|
| outsourced-packing | Outsourced packing | fromjapan, buyee, zenmarket | 82 | none | なし（公表されていない） |
...
|---|---|---|
| 1 | outsourced-packing | 82 → **0** |

## 3. 断定できている条件の偏り

断定できた 261 件の内訳:

国別: US=49, GB=49, FR=44, DE=42, CA=37, SG=35, AU=5

重量別: 2000g=42, 3000g=42, 5000g=41, 8000g=41, 200g=32, 1000g=32, 500g=31

価格別: ¥60000=42, ¥100000=42, ¥150000=41, ¥250000=37, ¥3000=35, ¥10000=33, ¥30000=31
...
- 公表されていない（unpublished）: 1 費目 / 延べ 82 条件
  - **outsourced-packing**（82条件）: FROM JAPAN の外注梱包費。同社は公表しておらず、社固有の未取得（scope無し）。
