...
// 三菱UFJ銀行の外国為替公示相場も当たったが、公示相場ページ
// (bk.mufg.jp/ippan/kinri/kawase_rate.html) は 2026-09-06 時点で 404。日本銀行の
// 主要時系列 (fm08_d_1) は東京市場の USD/JPY だけで、しかも最終データが 09-02 と
// 2日遅れだった。**6通貨を同じ時点で揃えられるのは ECB だけだった。**
//
